...
In this manuscript, we will present three different statistical frameworks that may be used to infer the susceptible fraction from aggregate time-series data and incorporate these estimates of population susceptibility into models of disease transmission. 
